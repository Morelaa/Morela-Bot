...
// Upscaler HD opsional (PicsArt). Kalau gagal, sticker tetap dikirim pakai gambar original.
class PicsArtUpscaler {
    ...
    async enhanceImage(imageUrl, targetScale = 2) {
        ...
        const payload = {
            ...
            // face_enhancement dimatikan: payload lama (max_faces:1000) ditolak
            // backend PicsArt dengan HTTP 422, bikin upscale gagal terus dan
            // sticker selalu fallback ke gambar non-HD. Terverifikasi via eval
            // langsung dari WA pada 13/7/2026 — job DONE setelah enabled:false.
